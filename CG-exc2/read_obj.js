...
Mesh.prototype.computeNormals = function() {
	...
	for (var i = 0; i < this.F.length; i++) {
		var f = this.F[i]; var t = new Triangle(this.V[f.e(1)],this.V[f.e(2)],this.V[f.e(3)]);
		this.N[f.e(1)] = this.N[f.e(1)].add(t.normal.multiply(t.get_area()));
		this.N[f.e(2)] = this.N[f.e(2)].add(t.normal.multiply(t.get_area()));
		this.N[f.e(3)] = this.N[f.e(3)].add(t.normal.multiply(t.get_area()));
	}
